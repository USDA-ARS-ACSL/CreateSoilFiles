...
namespace test_database_app
{
    ...
    class Utilities
    {
      ...
      
        {
            ...
            dtNodal.Columns.Add(new DataColumn("HumusN", typeof(double)));
            dtNodal.Columns.Add(new DataColumn("HumusC", typeof(double)));
            dtNodal.Columns.Add(new DataColumn("LitterN", typeof(double)));
            dtNodal.Columns.Add(new DataColumn("LitterC", typeof(double)));
            dtNodal.Columns.Add(new DataColumn("ManureN", typeof(double)));
            dtNodal.Columns.Add(new DataColumn("ManureC", typeof(double)));
